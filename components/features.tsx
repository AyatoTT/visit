      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Наши услуги.</h2>
            <p className="text-xl text-gray-400">Мы предлагаем широкий спектр услуг от разработки программного обеспечения до администрирования ваших проектов.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up"
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64"
                   className="bi bi-code-square w-16 h-16 mb-4" viewBox="0 0 16 16">
                <path className="fill-current text-white-600"
              ...
              <h4 className="h4 mb-2">WEB разработка</h4>
              <p className="text-lg text-gray-400 text-center">Наша команда специалистов по разработке веб-приложений
                создаст для вас современное, функциональное и интуитивно понятное веб-приложение, отвечающее вашим
                потребностям.</p>
            </div>
