      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">ProstoTeam - простые решения, надежный результат</h2>
            <p className="text-xl text-gray-400">Почему выбирают нас? Мы объединяем в себе простоту взаимодействия, высокое качество услуг и надежность в каждом решении. Присоединяйтесь к нам и дайте вашему бизнесу новые возможности в сфере информационных технологий.</p>
          </div>
